...
<head>
    ...
    <title>{{ config('app.name', 'bo3bdo Admin') }}</title>
...
<div class="wrapper">
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" data-widget="pushmenu" href="#" data-enable-remember="true" data-animation-speed="1200"  data-no-transition-after-reload="true" role="button"><i class="fas fa-bars"></i></a>
            </li>
